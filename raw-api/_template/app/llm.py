...
stores it on app state, and unit tests pass in a stub so nothing hits the
network.

qwen3 has a "thinking" mode; we disable it by prepending ``/no_think`` to the
...
def chat(
    ...
    *,
    ...
    """Single grounded chat call. Returns the assistant message text."""
